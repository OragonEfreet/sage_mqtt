...
use codec::{
    ReadByte, ReadFourByteInteger, ReadTwoByteInteger, ReadVariableByteInteger, WriteByte,
    WriteFourByteInteger, WriteTwoByteInteger, WriteVariableByteInteger,
};
...
pub use dep_codec::{BinaryData, Decode, Encode, QoS, UTF8String};
