...
mod unit {
    ...
    fn encoded() -> Vec<u8> {
        vec![
            5, 57, 18, 11, 195, 3, 38, 0, 7, // ???
            77, 111, 103, 119, 97, 195, 175, // Mogwaï
            0, 3, 67, 97, 116, // Cat
            0, 6, 104, 97, 114, 100, 101, 114, // harder
            1,   // 0b0000_0001
            0, 6, 98, 101, 116, 116, 101, 114, // better
            20,  // 0b0001_0100
            0, 6, 102, 97, 115, 116, 101, 114, // faster
            14,  // 0b0000_1110
            0, 8, 115, 116, 114, 111, 110, 103, 101, 114, // stronger
            41,  // 0b0010_1001
        ]
    }

    // Note:
    // Mogwaï: 77 111 103 119 97 195 175
    // Cat: 67 97 116
    // harder: 104 97 114 100 101 114
    // better: 98 101 116 116 101 114
    // faster: 102 97 115 116 101 114
    // stronger: 115 116 114 111 110 103 101 114
